...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [11] = {.lex_state = 45, .external_lex_state = 5},
  ...
  [24] = {.lex_state = 23},
  [25] = {.lex_state = 26},
  [26] = {.lex_state = 45, .external_lex_state = 5},
  [27] = {.lex_state = 45, .external_lex_state = 5},
  [28] = {.lex_state = 45, .external_lex_state = 5},
  [29] = {.lex_state = 1, .external_lex_state = 5},
  [30] = {.lex_state = 1, .external_lex_state = 5},
  [31] = {.lex_state = 45, .external_lex_state = 5},
  ...
  [36] = {.lex_state = 45, .external_lex_state = 5},
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_jsx_section] = STATE(13),
    [sym_markdown_section] = STATE(13),
    [sym_interpolation] = STATE(7),
    [sym_import_statement] = STATE(27),
    [sym_html_component] = STATE(27),
    [sym_jsx_component] = STATE(27),
    [sym_end_of_line] = STATE(2),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_jsx_section_repeat1, 2),
  [15] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_jsx_section_repeat1, 2), SHIFT_REPEAT(48),
  [18] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_jsx_section_repeat1, 2), SHIFT_REPEAT(8),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jsx_section, 1),
  ...
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_markdown_section_repeat1, 2), SHIFT_REPEAT(43),
  ...
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 3),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_document_repeat2, 2),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat2, 2), SHIFT_REPEAT(39),
  ...
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_import_statement_repeat1, 2), SHIFT_REPEAT(25),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_statement_repeat1, 2),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_markdown_section, 2),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [88] = {.entry = {.count = 1, .reusable = false}}, SHIFT(38),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 6),
  [92] = {.entry = {.count = 1, .reusable = false}}, SHIFT(37),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 5),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_document_repeat2, 3),
  [98] = {.entry = {.count = 1, .reusable = false}}, SHIFT(35),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 4),
  [102] = {.entry = {.count = 1, .reusable = false}}, SHIFT(40),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 2),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 1, .production_id = 1),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 1, .production_id = 1),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jsx_component, 3),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 7),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 3),
...
enum ts_external_scanner_symbol_identifiers {
  ...
  ts_external_token_markdown = 3,
  ts_external_token_eof = 4,
};
